...
var _ReactGreeter = __webpack_require__(28);

var _ReactGreeter2 = _interopRequireDefault(_ReactGreeter);

var greeter = __webpack_require__(29);
document.querySelector("#root").appendChild(greeter());

(0, _reactDom.render)(_react2['default'].createElement(_ReactGreeter2['default'], null), document.getElementById('root'));
...
var ad = { eventTypes: Dc, _isInputEventSupported: Kc, extractEvents: function extractEvents(a, b, c, d) {
    var e = b ? qb(b) : window,
        f = e.nodeName && e.nodeName.toLowerCase();if ("select" === f || "input" === f && "file" === e.type) var g = Jc;else if (vc(e)) if (Kc) g = $c;else {
      g = Oc;var h = Nc;
...
var xd = Object.freeze(Object.defineProperties({ setHandleTopLevel: function setHandleTopLevel(a) {
    sd = a;
  }, setEnabled: ud, isEnabled: function isEnabled() {
    return td;
  }, trapBubbledEvent: U, trapCapturedEvent: wd, dispatchEvent: vd }, {
  _enabled: {
    get: function get() {
      return td;
    },
...
function kf(a) {
  function b(a) {
    Qb = ja = !0;var b = a.stateNode;b.current === a ? E("177") : void 0;b.isReadyForCommit = !1;id.current = null;if (1 < a.effectTag) if (null !== a.lastEffect) {
...
if (l.canUseDOM) if ("function" !== typeof requestIdleCallback || "function" !== typeof cancelIdleCallback) {
  var uf = null,
    ...
    if (a.source === window && a.data === Cf) {
      vf = !1;a = rf();if (0 >= yf - a) if (-1 !== wf && wf <= a) Bf.didTimeout = !0;else {
...
function Nf(a, b) {
  ...
  Nf(a, b);var c = b.value;if (null != c) if (0 === c && "" === a.value) a.value = "0";else if ("number" === b.type) {
...
function sg(a, b, c, d, e) {
  var f = null;switch (b) {case "input":
    ...
    } else a || (f || (f = []), f.push(g, a)), a = k;else "dangerouslySetInnerHTML" === g ? (k = k ? k.__html : void 0, b = b ? b.__html : void 0, null != k && b !== k && (f = f || []).push(g, "" + k)) : "children" === g ? b === k || "string" !== typeof k && "number" !== typeof k || (f = f || []).push(g, "" + k) : "suppressContentEditableWarning" !== g && "suppressHydrationWarning" !== g && (Ra.hasOwnProperty(g) ? (null != k && lg(e, g), f || b === k || (f = [])) : (f = f || []).push(g, k));
...
// `preventDefault`.
batchedUpdates(handleTopLevelImpl,bookKeeping);}finally {releaseTopLevelCallbackBookKeeping(bookKeeping);}}var ReactDOMEventListener=Object.freeze(Object.defineProperties({setHandleTopLevel:setHandleTopLevel,setEnabled:setEnabled,isEnabled:isEnabled,trapBubbledEvent:trapBubbledEvent,trapCapturedEvent:trapCapturedEvent,dispatchEvent:dispatchEvent},{_enabled:{get:function get(){return _enabled;},configurable:true,enumerable:true},_handleTopLevel:{get:function get(){return _handleTopLevel;},configurable:true,enumerable:true}})); /**
...
var _configJson = __webpack_require__(14);

var _configJson2 = _interopRequireDefault(_configJson);

var ReactGreeter = (function (_Component) {
  _inherits(ReactGreeter, _Component);

  function ReactGreeter() {
    _classCallCheck(this, ReactGreeter);

    _get(Object.getPrototypeOf(ReactGreeter.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ReactGreeter, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        null,
        '"//ReactGreeter.js"',
        _configJson2['default'].greetText
      );
    }
  }]);
